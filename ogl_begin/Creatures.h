...
int getCoordPlane(int coord); int getCoordMap(int coord);
	...
	public:
		...
		std::string getLvlString() const;
		std::string getAgilityString() const;
		std::string getPowerString() const;
		std::string getIntelligenceString() const;
		std::string getProtectionString() const;
		std::string getDmgString() const;
		std::string getMovepointsString() const;
